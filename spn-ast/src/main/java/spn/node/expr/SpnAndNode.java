...
/**
 * Short-circuit boolean AND. Evaluates the right operand only if the left is true.
 *
 ...
 */
@NodeInfo(shortName = "&&")
public final class SpnAndNode extends SpnExpressionNode {
    ...
    public SpnAndNode(SpnExpressionNode left, SpnExpressionNode right) {
        this.left = left;
        this.right = right;
    }
